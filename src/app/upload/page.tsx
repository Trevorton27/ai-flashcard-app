  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div className="border-b border-zinc-200 pb-6">
        <h1 className="text-3xl font-semibold text-zinc-900 tracking-tight">Upload Vocabulary</h1>
        <p className="text-zinc-500 mt-1">
          Add new words to your collection using AI-powered processing
        </p>
      </div>

      <div className="bg-white rounded-2xl shadow-sm ring-1 ring-zinc-200 p-6 sm:p-8">
        <EnhancedUploadForm onComplete={handleComplete} />
      </div>

      <div className="bg-zinc-50 rounded-xl p-6 ring-1 ring-zinc-200">
        <h3 className="text-sm font-semibold text-zinc-900 mb-3">Supported Formats</h3>
        ...
        <div className="mt-4 pt-4 border-t border-zinc-200">
          <h4 className="text-sm font-medium text-zinc-900 mb-2">AI Features</h4>
